...
class PartialMember:
    ...
    def __init__(
        ...
        *,
        ...
        self.communication_disabled_until = siso(
            data.get("communication_disabled_until")
        )
        self.avatar_decoration_data = scls(
...
class Member(PartialMember):
    ...
    def __init__(
        ...
        *,
        ...
        if user_id is None:
            raise ValueError(
                "Both user object and user_id cannot be None for a member object."
            )
